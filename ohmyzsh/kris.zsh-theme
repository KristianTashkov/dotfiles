...
git_super_status() {
    ...
    if [ -n "$__CURRENT_GIT_STATUS" ]; then
      STATUS="$ZSH_THEME_GIT_PROMPT_PREFIX$ZSH_THEME_GIT_PROMPT_BRANCH$GIT_BRANCH/$ZSH_THEME_GIT_PROMPT_HASH$GIT_HASH%{${reset_color}%}"
...
PROMPT='$(git_super_status) %{$fg[cyan]%}[%~% ]%{$reset_color%}%B$%b '
RPROMPT="[%*]"
